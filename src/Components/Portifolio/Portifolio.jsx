...
import icon3 from "../../Assets/chat-online.png"
          ...
          <div className='grid'>
            <div className="singlePortifolio flex">
              ...
              <div className="infor" data-aos='fade-up'>
                <h4 data-aos='fade-up'>Safe and support</h4>
                <p data-aos='fade-up'>
                  Whether it's a docmestic tour
                  or an international adventure,
                  we cover a wide range of 
                  destinations to cater to
                  different interests and preferces
                </p>
              </div>
            </div>
            ...
            <div className="singlePortifolio flex" data-aos='fade-up'>
              ...
              <div className="infor">
                ...
                <p>
                  ...
                  and have emergency support available
                  during the trip
                </p>
              </div>
            </div>
